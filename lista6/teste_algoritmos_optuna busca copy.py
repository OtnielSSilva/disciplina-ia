...
# Função para realizar várias execuções e coletar o número de nós explorados
...
def objective(trial):
    ...
    # Usamos a soma dos nós explorados como objetivo de minimização
...
print("Melhor Heurística Encontrada:", melhor_heuristica)
...
if p_value < 0.05:
    print("Diferença estatisticamente significativa entre as buscas Gulosa e A*.")
else:
    print("Nenhuma diferença estatisticamente significativa encontrada entre as buscas Gulosa e A*.")
